...
import { ClassListPrintScreen } from './screens/ClassListPrintScreen'
...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/class/:classId/print" element={<RequireAuth><AppServicesProvider><ClassListPrintScreen /></AppServicesProvider></RequireAuth>} />
